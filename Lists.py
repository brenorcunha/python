...
lista=[1,2,2,3,4,5,6,99,0,1,1,5,8,9,0,21,22,23]
def encontra_elementos_duplicados(lista):
    # """
    ...
    duplicatas = (list(set([num for num in lista if lista.count(num) >1])))
    
    #lista sem duplicatas:
    
    #A saída do algoritmo é a lista de elementos repetidos.
    return duplicatas
duplicatas = encontra_elementos_duplicados(lista)
print('Números duplicados: ', duplicatas)
